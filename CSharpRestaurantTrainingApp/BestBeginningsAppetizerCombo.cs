...
{
    public partial class frmBestBeginningsAppetizerCombo : Form
    {
        public frmBestBeginningsAppetizerCombo()
        {
            InitializeComponent();
        }
        ...
        {
            this.Close();
            new frmSpinachandArtichokeDip().Show();
        }
        ...
        {
            this.Close();
            new frmRootBeerGlazedRibs().Show();
        }
    }
}
